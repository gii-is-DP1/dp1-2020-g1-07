...
public class EventController {
	...
	@GetMapping()
	public String eventsListed(ModelMap modelMap) {
		String view = "stages/listEvent";
		Iterable<Event> events=eventService.findAll();
		modelMap.addAttribute("stages", events);
		return view;
	}

	@GetMapping(path="/new")
	public String createEvent(ModelMap modelMap) {
		String view="stages/addEvent";
