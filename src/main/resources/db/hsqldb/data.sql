...
INSERT INTO users(username,password,dni,authorities_id) VALUES ('admin1','4dm1n','12345678A',1);

-- EMPLOYEE: artist1|artist1
INSERT INTO authorities VALUES(2,'employee');
INSERT INTO users(username,password,dni,authorities_id) VALUES ('artist1','artist1','98765431Z',2);

-- CLIENT: client1|client1
INSERT INTO authorities VALUES(3,'client');
INSERT INTO users(username,password,dni,authorities_id) VALUES ('client1','client1','11111111A',3);
