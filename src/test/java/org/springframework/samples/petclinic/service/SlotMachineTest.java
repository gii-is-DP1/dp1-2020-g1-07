...
public class SlotMachineTest {
	...
	void testAddingNewSlotMachine() {
		...
		assertThat(saved_slotMachine.getName().equals("new SlotMachine"));
		assertThat(saved_slotMachine.getStatus().getName().equals("COLLECT"));		
		assertThat(saved_slotMachine.getSlotgame().getName().equals("Game 1"));
	}
