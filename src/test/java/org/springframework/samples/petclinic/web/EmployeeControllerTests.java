...
includeFilters = @ComponentScan.Filter(value = EmployeeValidator.class, type = FilterType.ASSIGNABLE_TYPE ),
...
public class EmployeeControllerTests {
    ...
    void testProcessCreationRepeatedDni() throws Exception {
		mockMvc.perform(post("/employees/save")
			...
			.andExpect(model().attributeHasFieldErrors("employee", "dni"))
			.andExpect(view().name("employees/addEmployee"));
	}
    ...
    void testProcessCreationFormHasErrors() throws Exception {
		mockMvc.perform(post("/employees/save")
			...
			.andExpect(model().attributeHasErrors("employee"))
			.andExpect(model().attributeHasFieldErrors("employee", "dni"))
			.andExpect(model().attributeHasFieldErrors("employee", "phone_number"))
			.andExpect(view().name("employees/addEmployee"));
	}
